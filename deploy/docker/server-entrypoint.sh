...
export BF_FIRMWARE_SIGNING_KEY_BASE64="$(printf '%s' "$BF_FIRMWARE_SIGNING_KEY" | base64 | tr -d '\n')"
export BF_CLIENT_FIRMWARE_PUBLIC_KEY_BASE64="$(printf '%s' "$BF_CLIENT_FIRMWARE_PUBLIC_KEY" | base64 | tr -d '\n')"
